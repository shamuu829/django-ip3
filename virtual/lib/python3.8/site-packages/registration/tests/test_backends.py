...
class RegistrationBackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        self.assertTrue(isinstance(backend, DefaultRegistrationBackend))
...
class DefaultRegistrationBackendTestCase(TestCase):
    ...
    def test_activation_with_password(self):
        ...
        self.assertTrue(activated_user.check_password('swardfish'))
    ...
    def test_allow(self):
        ...
        self.assertTrue(self.backend.registration_allowed())

        settings.REGISTRATION_OPEN = False
        self.assertFalse(self.backend.registration_allowed())
        settings.REGISTRATION_OPEN = old_allowed

    def test_get_registration_form_class(self):
        form_class = self.backend.get_registration_form_class()
        self.assertTrue(form_class is forms.RegistrationForm)

    def test_get_activation_form_class(self):
        form_class = self.backend.get_activation_form_class()
        self.assertTrue(form_class is forms.ActivationForm)
